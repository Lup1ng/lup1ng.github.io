...
var main = (function($) { var _ = {
	...
	initProperties: function() {
		...
		// IE<9: 100="" fix="" viewer="" width="" (no="" calc="" support).="" if="" (skel.vars.ieversion="" <="" 9)="" _.$window="" .on('resize',="" function()="" {="" window.settimeout(function()="" _.$viewer.css('width',="" _.$window.width()="" -="" _.$main.width());="" },="" 100);="" })="" .trigger('resize');="" **="" *="" initialize="" events.="" initevents:="" window.="" remove="" is-loading-*="" classes="" on="" load.="" _.$window.on('load',="" _.$body.removeclass('is-loading-0');="" _.$body.removeclass('is-loading-1');="" _.$body.removeclass('is-loading-2');="" +="" math.max(_.settings.layoutduration="" 150,="" 0));="" });="" disable="" animations="" transitions="" resize.="" var="" resizetimeout;="" _.$window.on('resize',="" _.$body.addclass('is-loading-0');="" window.cleartimeout(resizetimeout);="" resizetimeout="window.setTimeout(function()" viewer.="" hide="" main="" wrapper="" tap="" (<="medium" only).="" _.$viewer.on('touchend',="" (skel.breakpoint('medium').active)="" _.hide();="" touch="" gestures.="" _.$viewer="" .on('touchstart',="" function(event)="" record="" start="" position.="" _.$viewer.touchposx="event.originalEvent.touches[0].pageX;" _.$viewer.touchposy="event.originalEvent.touches[0].pageY;" .on('touchmove',="" no="" position="" recorded?="" bail.="" (_.$viewer.touchposx="==" null="" ||="" null)="" return;="" calculate="" stuff.="" diffx="_.$viewer.touchPosX" event.originalevent.touches[0].pagex,="" diffy="_.$viewer.touchPosY" event.originalevent.touches[0].pagey;="" boundary="20," delta="50;" swipe="" left="" (next).="" (="" (diffy="" &&=""> (-1 * boundary)) && (diffX > delta) )
								_.next();
	...
	init: function() {
		...
		// IE<10: zero="" out="" transition="" delays.="" if="" (skel.vars.ieversion="" <="" 10)="" {="" _.settings.slideduration="0;" _.settings.layoutduration="0;" }="" skel.="" skel.breakpoints({="" xlarge:="" '(max-width:="" 1680px)',="" large:="" 1280px)',="" medium:="" 980px)',="" small:="" 736px)',="" xsmall:="" 480px)'="" });="" everything="" else.="" _.initproperties();="" _.initviewer();="" _.initevents();="" initial="" slide.="" window.settimeout(function()="" show="" first="" slide="" xsmall="" isn't="" active="" or="" it="" just="" deactivated.="" skel.on('-xsmall="" !xsmall',="" function()="" (_.current="==" null)="" _.switchto(0,="" true);="" },="" 0);="" **="" *="" switch="" to="" a="" specific="" @param="" {integer}="" index="" index.="" switchto:="" function(index,="" nohide)="" already="" at="" and="" active?="" bail.="" &&="" !skel.breakpoint('xsmall').active)="" return;="" locked?="" (_.locked)="" lock.="" _.locked="true;" hide="" main="" wrapper="" medium="" is="" active.="" (!nohide="" skel.breakpoint('medium').active="" skel.vars.ieversion=""> 8)
				_.hide();
	...
	previous: function() {
		...
		// Calculate new index.
			...
			if (c <= 1="" 0)="" i="l" -="" 1;="" else="" switch.="" _.switchto(i);="" },="" **="" *="" switches="" to="" slide="" "above"="" current.="" up:="" function()="" {="" fullscreen?="" bail.="" if="" (_.$body.hasclass('fullscreen'))="" return;="" calculate="" new="" index.="" var="" i,="" c="_.current," l="_.slides.length," tpr="_.settings.thumbnailsPerRow;" (c="" <="(tpr" 1))="" (tpr="" c)="" tpr;="" "below"="" down:="">= l - tpr)
				i = c - l + tpr;
			else
				i = c + tpr;
...
}; return _; })(jQuery); main.init();</=></10:></=></=></9:>